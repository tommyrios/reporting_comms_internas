...
Recibirás el texto extraído de un PDF mensual del dashboard de comunicaciones internas.
Tu tarea es devolver exclusivamente JSON válido, sin markdown, sin explicación extra.

Objetivo:
- resumir el mes con foco ejecutivo
- priorizar hallazgos claros, breves y visuales
- evitar prosa larga
- identificar datos, patrones, fortalezas y oportunidades

Formato de salida JSON:
{
  "period_label": "Mar 2026",
  "executive_summary": "Resumen ejecutivo breve de 2 o 3 frases.",
  "headline_metrics": [
    {"label": "Métrica 1", "value": "valor", "insight": "lectura corta"},
    {"label": "Métrica 2", "value": "valor", "insight": "lectura corta"},
    {"label": "Métrica 3", "value": "valor", "insight": "lectura corta"}
  ],
  "highlights": [
    "Hallazgo 1",
    "Hallazgo 2",
  ...
  "content_focus": [
    {"theme": "Tema", "detail": "detalle breve"},
    {"theme": "Tema", "detail": "detalle breve"}
  ]
}
...
- si faltan datos, inferir con prudencia y aclararlo en lenguaje breve
- no inventar métricas exactas que no estén sustentadas
- redactar en español corporativo, claro y corto
""".strip()
...
Recibirás una lista de resúmenes mensuales ya estructurados.
Tu tarea es devolver exclusivamente JSON válido, sin markdown, sin explicación extra.

Objetivo:
- consolidar el período en formato visual tipo presentación ejecutiva
- priorizar claridad, síntesis y foco gerencial
- evitar prosa larga

Formato de salida JSON:
{
  "title": "Informe mensual/trimestral/anual de Comunicaciones Internas",
  "subtitle": "Período ...",
  "executive_summary": "Resumen ejecutivo de 2 o 3 frases.",
  "headline_metrics": [
    {"label": "Métrica", "value": "valor", "insight": "lectura corta"},
    {"label": "Métrica", "value": "valor", "insight": "lectura corta"},
    {"label": "Métrica", "value": "valor", "insight": "lectura corta"}
  ],
  "key_wins": [
  ...
  "watchouts": [
    "Riesgo u oportunidad 1",
    "Riesgo u oportunidad 2"
  ],
  "monthly_snapshots": [
    {
      "month": "Mes",
      "summary": "Lectura ejecutiva muy breve"
    }
  ],
  "next_steps": [
    "Siguiente paso 1",
...
Reglas:
- devolver solo JSON válido
- no inventar métricas exactas si no están claras
- redactar en español corporativo, claro y corto
""".strip()
